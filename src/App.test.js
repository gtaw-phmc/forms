...
[list=none]
[*][${formData.patientPhoneType === 'Mobile' ? '*' : ''}] Mobile
[*][${formData.patientPhoneType === 'Home' ? '*' : ''}] Home
[*][${formData.patientPhoneType === 'Work' ? '*' : ''}] Work
[*][${formData.patientPhoneType === 'Other' ? '*' : ''}] Other[/list][b]Phone Number:[/b]
[i]${patientPH}[/i][br][/br]
[b]Email:[/b]
...
[list=none]
[*][${formData.CarePurposeMedicalInformationRelease === 'Further Treatment' ? '*' : ''}] Further Treatment / Continued 
[*][${formData.CarePurposeMedicalInformationRelease === 'Personal' ? '*' : ''}] Personal Use
[*][${formData.CarePurposeMedicalInformationRelease === 'Attorney' ? '*' : ''}] Attorney / Client
[*][${formData.CarePurposeMedicalInformationRelease === 'Other' ? '*' : ''}] Other: ${patientMedInfoReleaseOther}[/list][/list]
[list=none][b]Format of Medical Information Release:[/b]
[list=none]
[*][${formData.PurposeMedicalInformationReleaseFormat === 'CopyofRecords' ? '*' : ''}] Copy of Record to be picked up
[*][${formData.PurposeMedicalInformationReleaseFormat === 'VerbalRelease' ? '*' : ''}] Verbal Release (e.g. phone conversation)
[*][${formData.PurposeMedicalInformationReleaseFormat === 'ElectronicRelease' ? '*' : ''}] Electronical Release (sent via email)
[*][${formData.PurposeMedicalInformationReleaseFormat === 'Other' ? '*' : ''}] Other: ${patientMedInfoFormatOther}[/list][/list]
    ...
    <label>Morgue Bugs:</label>
                            ...
                            <>
                                ...
                                {formData.CarePurposeMedicalInformationRelease === 'Other' && (
                                    <Form.Control
                                        ...
                                        onChange={handleChange}
                                        placeholder="patientMedInfoReleaseOther"
                                        required
                            ...
                            <Select
                                ...
                                />
                                    ...
                                    <Form.Label>Authorization For Release Information - ADD DATE</Form.Label>
                                    <Form.Control
    type="date"
    name="SubmitDate"
                ...
                <Modal.Body>
                    <Form>
                        <Form.Group className="mb-3">
                            ...
                            />
                            <Form.Label>Employee Discord:</Form.Label>
                            <Form.Control
                                type="text"
                                name="coronerDiscord"
                                ...
                                onChange={handleMissingEmployeeChange}
                            />
                            <Form.Label>Employee Rank:</Form.Label>
                            <Form.Control
                                type="text"
                                name="coronerRank"
                                ...
                                onChange={handleMissingEmployeeChange}
                            />
                            <Form.Label>Employee PH:</Form.Label>
                            <Form.Control
                                type="text"
                                name="coronerPHNumber"
