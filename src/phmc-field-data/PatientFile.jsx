...
const PatientFile = ({
    ...
    const [formType, setFormType] = useState('basic'); // 'basic' or 'advanced'
    ...
    return (
        <>
            <Form.Group className="mb-3">
                ...
                <div>
                    <Button variant={formType === 'basic' ? 'primary' : 'secondary'} onClick={() => setFormType('basic')}>Basic</Button>
                    <Button variant={formType === 'advanced' ? 'primary' : 'secondary'} onClick={() => setFormType('advanced')} className="ms-2">Advanced</Button>
                </div>
            </Form.Group>
            ...
            {formType === 'basic' && (
                <div className="alert alert-info" style={{ marginBottom: '1rem' }}>
                    <strong>Basic Patient File:</strong> Contains essential patient information including general details, emergency contacts, and basic medical history. Perfect for standard patient registration and basic healthcare needs.
                </div>
            )}
            {formType === 'advanced' && (
                <div className="alert alert-info" style={{ marginBottom: '1rem' }}>
                    <strong>Advanced Patient File:</strong> Includes all basic information plus comprehensive mental health history, family medical background, social and lifestyle details, and advanced healthcare directives. Ideal for complex cases requiring detailed patient profiling.
                </div>
            )}
