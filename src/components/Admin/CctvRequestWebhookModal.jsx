            ...
            <div className="cctv-modal-dialog" onClick={e => e.stopPropagation()}>
                ...
                <div className="cctv-modal-body">
                    <div className="cctv-danger-text">
                        ...
                        <div>
                            <strong>Legal Notice:</strong> This form directly requests CCTV footage from PHMC supervisors. Expect a response within 24 hours via phone or departmental channels.
                            <br />
                            <br />
                            ...
                            <div className="auth-details">
                                ...
                                {swappableCharacters && swappableCharacters.length > 0 && (
                                    <div className="character-selector">
                                        ...
                                        <select
                                            className="form-control character-select" // Using character-select for specific styling
                    ...
                    <div className="cctv-form-section">
                        ...
                        <div className="cctv-form-row">
                            ...
                            <div className="cctv-form-group">
                                ...
                                <select
                                    className="form-control cctv-select" // Use cctv-select for styling
                                    value={requestReason}
